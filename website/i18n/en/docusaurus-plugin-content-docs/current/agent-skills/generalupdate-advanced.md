...
> ⚠️ **API Version Note**: This guide is based on **NuGet v10.5.0-beta.7**.
> All the following features are **available** in v10.5.0-beta.7:
...
|---------|-------------|-----------|
| Pipeline | ✅ v10.5.0-beta.7 | `GeneralUpdate.Core.Pipeline` |
| Strategy System | ✅ v10.5.0-beta.7 | `GeneralUpdate.Core.Strategy` |
...
| AOT | ✅ v10.5.0-beta.7 | `JsonSerializerContext` subclasses |
| EventManager | ✅ v10.5.0-beta.7 | `GeneralUpdate.Core.Event` |
| Bowl Crash Daemon | ✅ v10.5.0-beta.7 | `GeneralUpdate.Bowl.Bowl` |
| IUpdateHooks | ✅ v10.5.0-beta.7 | `GeneralUpdate.Core.Hooks` — `Hooks<T>()` |
| Custom Strategy Injection | ✅ v10.5.0-beta.7 | `Strategy<T>()` |
...
| Option System | ✅ v10.5.0-beta.7 | `SetOption<T>(Option<T>, T)` |
